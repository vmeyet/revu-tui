...
| Your comments, kept as drafts | `P` publishes them all as one review |
...
| [Guides](docs/guides/) | One task per page: search, ready source, share, zen, AI, your editor, keys, hosts, update |
